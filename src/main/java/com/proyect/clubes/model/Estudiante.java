...
public class Estudiante {
    ...
    public Estudiante(String nombre, String carrera, String edad, String genero, String afluenciaPreferida, List<String> intereses, List<String> clubesAsistidos, List<String> accionesPreferidas) {
        this.nombre = nombre;
